...
//    protected Dictionary BtnDict;
                    ...
                    if(replyMsg != null){
                        Platform.runLater(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if(replyMsg.equals("X")){
                                ...
                                else if(replyMsg.equals("disconnect") && counter == 0){
                                    ...
                                    a.setHeaderText("Connection Lost");
                                    String content = String.format("the other player is no longer connected to server");
                                    a.setContentText(content);
                                    a.showAndWait();
                                }

                                else if(counter == 0) {
                                    dbPattern += String.valueOf(replyMsg.charAt(1));
                        ...
                        Platform.runLater(() -> {
                            ...
                            String content = String.format("the server is down");
                            a.setContentText(content);
                            a.showAndWait();
                        });
    ...
    public void check(){
        ...
        checkDiagonal();
        if(xWin || oWin){
            System.out.println(client.dbPattern);
            new DataBaseSet("multi","hossam","hossam","youssry",client.dbPattern);
            for (Button btnj : BtnArr){
